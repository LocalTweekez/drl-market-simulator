...
class TradingEnv(gym.Env):
    ...
    def reset(self, seed=None):
        ...
        if self.normalize:
            self.state = self._normalize_observation(self.state)
        return self.state, {}
    ...
    def step(self, action):
        ...
        self.info = {
            ...
            "Time": self.trade_env['time'][self.t],
    ...
    def _get_observation(self):
        if self.agent_policy == "MultiInputPolicy":
            obs = {
                ...
                'position': self.trade_env['pType'][self.t-self.batch_size : self.t]
            }
            print("Observation (MultiInputPolicy):", obs)  # Debugging line
            return obs
        else:
            ...
            positions = self.trade_env['pType'][self.t - self.batch_size: self.t]
            ...
            # print("Observation (Flattened):", obs.shape)  # Debugging line
            return obs
    ...
    def _normalize_observation(self, obs):
        ...
        print(f"obs shape: {obs}")  # Add this line to check the shape of `obs`
